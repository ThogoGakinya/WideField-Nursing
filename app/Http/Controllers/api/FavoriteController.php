    ...
    public function favoritelist(Request $request)
    {
        ...
        if($request->type == "providers"){
            ...
            $favoriteproviders = User::with('api_rattings')
                    ...
                    ->select('users.id','users.name as provider_name','provider_types.name as provider_type','users.email','users.mobile','users.address','cities.name as city_name','users.about','users.login_type',
