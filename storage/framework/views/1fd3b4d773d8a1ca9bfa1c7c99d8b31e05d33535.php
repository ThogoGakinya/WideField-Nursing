              ...
              <!--       
                ...
                -->   
                     ...
                     <?php if(!Session::get('id')): ?>
                        ...
                        <li class="<?php echo e(request()->is('home/contact-us*') ? 'active' : ''); ?> "><a href="<?php echo e(URL::to('/home/contact-us')); ?>"><?php echo e(trans('labels.contact_us')); ?></a></li>
                     <?php endif; ?>
                     <li>
...
<?php /**PATH /home/medgorid/widefieldmedical.com/resources/views/front/layout/home_header_navbar.blade.php ENDPATH**/ ?>