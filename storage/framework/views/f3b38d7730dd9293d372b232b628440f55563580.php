...
<head>
   ...
   <body>
      ...
      <div class="main-wrapper">
         ...
         <?php echo $__env->make('front.layout.header_navbar', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                     ...
                     <div class="col-lg-3 col-md-6">
                        <div class="footer-widget footer-menu">
                           ...
                           <ul>
                              ...
                              <li><a href="<?php echo e(URL::to('/home/services/'.$categories->slug)); ?>"><?php echo e($categories->name); ?></a></li>
                              <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                           </ul>
                        </div>
                     </div>
...
</html><?php /**PATH /home/medgorid/widefieldmedical.com/resources/views/front/layout/main.blade.php ENDPATH**/ ?>